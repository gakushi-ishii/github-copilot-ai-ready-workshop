...
| 03 | [運用バグを Cloud Agent へ委託する](./lab/03-delegate-bug-to-cloud-agent.md) | Canvas・Issue から Agent 委託 |
| 04 | [Cloud Agent の実装内容を確認する](./lab/04-review-cloud-agent-pr.md) | Issue↔差分↔テスト↔CI の対応付け |
